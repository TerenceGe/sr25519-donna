...
keypair: the output ed25519 compatible keypair, 96 bytes long {{{NEWLINE}}}
...
** sign message
signature: the signature ouput, 64 bytes long {{{NEWLINE}}}
public:    the public key of the keypair to sign the message, 32 bytes long {{{NEWLINE}}}
secret:    the secret key of the keypair to sign the message, 64 bytes long {{{NEWLINE}}}
