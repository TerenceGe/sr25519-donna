...
int ed25519ph_sign_open(const unsigned char *m, size_t mlen, const ed25519_public_key pk, const unsigned char *dom2, size_t dom2_len, const ed25519_signature RS);
void ed25519_sign(const unsigned char *m, size_t mlen, const ed25519_secret_key sk, const ed25519_public_key pk, ed25519_signature RS);
void ed25519ph_sign(const unsigned char *m, size_t mlen, const ed25519_secret_key sk, const ed25519_public_key pk, const unsigned char *dom2, size_t dom2_len, ed25519_signature RS);
#if USE_CARDANO
