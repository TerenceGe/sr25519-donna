...
void merlin_transcript_commit_bytes(merlin_transcript* mctx, const uint8_t* label, size_t label_len, const uint8_t* data, size_t data_len);
...
void merlin_commit_witness_bytes(merlin_transcript* mctx, uint8_t* dest, size_t dest_len, const uint8_t* label, size_t label_len, const uint8_t* witness, size_t witness_len);
