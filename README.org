...
keypair: the output ed25519 compatible keypair, 96 bytes long #+HTML: <br>
...
** sign message
signature: the signature ouput, 64 bytes long #+HTML: <br>
public:    the public key of the keypair to sign the message, 32 bytes long #+HTML: <br>
secret:    the secret key of the keypair to sign the message, 64 bytes long #+HTML: <br>
